...
@dataclass
class UNet2DDualConditionOutput(BaseOutput):
    """
...
class UNet2DMaskConditionModel(
    ...
    def __init__(
        ...
        #     nn.Conv2d(block_out_channels[0], 128, 3, padding=1),
        #     nn.GroupNorm(32, 128),
        #     nn.SiLU(),
        #     nn.Conv2d(128, 3, 1)
        # )
        self.mask_head = nn.Sequential(
            ...
            nn.Upsample(scale_factor=2, mode="bilinear", align_corners=False),
            nn.Conv2d(32, mask_out_channels, 1)
        )
    ...
    def forward(
    ...
    ) -> Union[UNet2DDualConditionOutput, Tuple]:
        r"""
        ...
        image = self.conv_out(sample)
        mask = self.mask_head(sample)
        ...
        return UNet2DDualConditionOutput(sample=image, mask=mask)
